...
<div class="row">
          ...
          <div id="line" class="list-group list-group-horizontal">
            <?php
              foreach ($user_board['users_blocks'] as $block) {
                $title = $block['title'];
                $block_id = $block['id'];
                echo "<a href='#' data-block='$block_id' class='list-group-item block'>$title</a>";

              }
            ?>
              <a href="#" data-toggle="modal" data-target="#build_block_modal" class="list-group-item active"><i class="fa fa-plus" aria-hidden="true"></i></a>
          </div>
      </div>
	</div>
  ...
  <div id="book_controller"  class="col-xs-12 col-sm-6">
    <div class='panel panel-default' >
      <div class='panel-heading'><span class="pull-right hidden-sm visible-xs see_block_controller"><i class="fa fa-cube fa-2x" aria-hidden="true"></i></span><h4 class='text-center'>Scriptures<h4> </div>
  ...
  <div id="block_controller" class="col-xs-12 hidden-xs col-sm-6">
    <div class='panel panel-default' >
      <div class='panel-heading'><span class="pull-left hidden-sm visible-xs see_book_controller"><i class="fa fa-book fa-2x" aria-hidden="true"></i></span><h4 id="block_title" class='text-center'>Panel title<h4></div>
